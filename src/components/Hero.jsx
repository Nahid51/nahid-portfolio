...
import nahidPhoto from '../assets/images/Nahid-removebg-preview.png';
            ...
            <div className='md:my-28 my-10'>
                <div className='grid md:grid-cols-2 grid-cols-1'>
                    ...
                    <div>
                        ...
                        <p className='mb-7 text-sm text-justify'>A junior full-stack web developer which is able to build a full web application using different types of web concepts and tools, navigation, layout, and programming. Using my two years of experience, I have made many projects.</p>
